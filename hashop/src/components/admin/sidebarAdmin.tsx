                ...
                },
                {
                    ...
                    subItems2: [
                        { label: t('admin.sidebar.Overview'), level: 2, route: 'e-commerce' },
                        {
                            ...
                            level: 2,
                            subItems3: [
                                { label: t('admin.sidebar.Products'), level: 3, route: 'e-commerce/product' },
                                { label: t('admin.sidebar.Product Details'), level: 3, route: 'e-commerce/product/details' },
                                { label: t('admin.sidebar.Add Product'), level: 3, route: 'e-commerce/product/add' },
                            ],
                        },
                        {
                            ...
                            level: 2,
                            subItems3: [
                                { label: t('admin.sidebar.Orders'), level: 3, route: 'e-commerce/order' },
                        ...
                        },
                        {
                            ...
                            level: 2,
                            subItems3: [
                                { label: t('admin.sidebar.Customers'), level: 3, route: 'e-commerce/customer' },
                                { label: t('admin.sidebar.Customer Details'), level: 3, route: 'e-commerce/customer/details' },
                                { label: t('admin.sidebar.Add Customers'), level: 3, route: 'e-commerce/customer/add' },
                            ],
                        },
